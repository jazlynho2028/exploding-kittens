...
| # | Item                                                                                                                                                         |  Status   | Reviewer Notes      | Source Instructions or Resources                                                  |
|---|--------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------:|---------------------|-----------------------------------------------------------------------------------|
| 1 | Each active feature branch has an open draft PR against main.                                                                                                |  ✅         |  Y'all draft PRs look very beautiful. I can see that a lot of progress are being made behind the scene. Happy to see that!                   | Week 4 Wednesday Lecture (Lecture 08)                                             |
| 2 | The team has a “definition of done” (BVA) fully documented for the part of the system that is done. (needed for Letter Grade D)                              | ✅          | I am seeing that you guys are still in your work in progress with the BVAs. BVAs have been made but then PR closed. From Jazlyn's feedback, I hear that a lot of thought process and design have been taking place behind the scene, so I'll give you guys a ✅. Just make sure not to dwell too much with the BVAs. You can always edit it more after it's pushed.                    | Project grading rubrics                                                           |
...
| # | Item                                                                                                                                                         |  Status   | Reviewer Notes      | Source Instructions or Resources                                                  |
|---|--------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------:|---------------------|-----------------------------------------------------------------------------------|
| 4 | The team documents every week’s planning and progress evaluation professionally. (needed for Letter Grade B)                                                 | ✅          |  Looking good!                   | Week 4 Wednesday Lecture (Lecture 08), Project grading rubrics                    |

### Progress & Collaboration
| # | Item                                                                                                                                                                                   |  Status   | Reviewer Notes      | Source Instructions or Resources                 |
|---|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------:|---------------------|--------------------------------------------------|
| 5 | Overall development progress (recall the recommended order is: Game Setup Phase -> One turn of the game -> Multiple turns -> One win condition -> Other win conditions (if applicable) | ⚠️          |  I am happy to see that the Game Setup Phase is getting done, especially with all the draft PRs. I know that there is a slight bottleneck from talking with a member of your team but just keep up the good works and you all will caught up!                   | Canvas assignment Project: Week 4 and 5 Guidance |
