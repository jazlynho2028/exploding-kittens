...
- **TC1: first player's index before any turns taken with list of too little players** ( x )
  - **State of the system**: TurnManager constructed with list of 1 player
  - **Expected output**: throws IllegalArgumentException

- **TC2: first player's index before any turns taken with list of two players** ( )
  - **State of the system**: TurnManager constructed with list of 2 players
  - **Expected output**: Returns 0 (first player's index)

- **TC3: first player's index before any turns taken with list of more than one player** ( checkmark )
    - **State of the system**: TurnManager constructed with list of 4 players
    - **Expected output**: Returns 0 (first player's index)

- **TC4: first player's index before any turns taken with list of too many players** ( x )
