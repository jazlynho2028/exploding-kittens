...
- **TC1: this method is called** ( :x: )
  ...
  - **Expected output**: onError has default empty handling, called buildAndBindUI

### Method under test: `buildAndBindUI()`
- **TC2: this method is called** ( :x: )
  - **Name of the test**: buildAndBindUI_called_success
  - **State of the system**: N/A
  - **Expected output**: called buildDependentUI and bindUI
...
- **TC4: this method is called** ( :x: )
  ...
  - **State of the system**: N/A
  - **Expected output**: called view.bindActionButtons, view.bindNameTags, and view.bindPlayerHandCardButtons
...
- **TC7: current player changes successfully** ( :white_check_mark: )
...
- **TC10: card is drawn from pile successfully** ( :white_check_mark: )
...
- **TC11: model throws InvalidStateException** ( :white_check_mark: )
...
- **TC13: cards are face down** ( :white_check_mark: )
...
- **TC15: game starts successfully** ( :white_check_mark: )
...
- **TC16: model throws InvalidStateException** ( :white_check_mark: )
